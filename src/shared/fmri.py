...
MR_settings = {
    ...
    "sync": ["5", "percent"],  # character to use as the sync timing event; assumed to come at start of a volume
...
def get_ttl():
    ...
    return any(key.lower() in MR_settings["sync"] for key in allKeys)
